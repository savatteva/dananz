    ...
    <header>
      <nav className={styles.nav}>
        ...
        <div className={isOpenBurger ? styles.burgerMenu : styles.rightMenu}>
          ...
          >
            <Typography text={t('home')} size="xs" />
          </NavLink>
          <NavLink to="/">
            <Typography text={t('about_us')} size="xs" />
          </NavLink>
          <NavLink to="/">
            <Typography text={t('services')} size="xs" />
          </NavLink>
          <NavLink to="/">
            <Typography text={t('our_teams')} size="xs" />
          </NavLink>
          <NavLink to="/">
            <Button variant="primary">
              <Typography text={t('contact_us')} color="white" size="xs" />
            </Button>
          </NavLink>
        </div>
